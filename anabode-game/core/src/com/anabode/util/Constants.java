...
public class Constants {
    ...
    public static final int CONSTRUCTION_OBJECT_RENDER_LAYER = 1;
    ...
    public static final short CONSTRUCTION_OBJECT_COLLISION_MASK = CONSTRUCTION_OBJECT_COLLISION_CATEGORY; // 0000 0001

    public static final short CONSTRUCTION_LADDER_COLLISION_MASK = CONSTRUCTION_LADDER_COLLISION_CATEGORY | PLAYER_COLLISION_CATEGORY; // 0000 0110

    public static final short PLAYER_COLLISION_MASK = CONSTRUCTION_LADDER_COLLISION_CATEGORY | PLAYER_COLLISION_CATEGORY; // 0000 0110
}
